...
.acard .bg{{position:absolute;inset:0;background-image:url(../pillars/art/{branch_slug}.jpg);background-size:cover;background-position:center}}
...
<div class="fhero wrap">
  ...
  <div class="acard"><span class="bg"></span><span class="sc"></span>
