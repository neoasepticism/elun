...
.acard .bg{{position:absolute;inset:0;background-image:url(../pillars/art/{branch_slug}.jpg);background-size:cover;background-position:left center}}
.acard .st{{position:absolute;right:-4%;top:-25%;width:46%;height:150%;background-image:url(../pillars/art/{stem_slug}.jpg);background-size:cover;background-position:center;mix-blend-mode:screen;opacity:.85;-webkit-mask-image:radial-gradient(ellipse 60% 60% at center,black 40%,transparent 74%);mask-image:radial-gradient(ellipse 60% 60% at center,black 40%,transparent 74%)}}
